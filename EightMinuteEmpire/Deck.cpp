...
//	// Print shuffled deck
//	cout << "\n" << endl;
//	Deck::printDeck(shuffleDeck(deck));
//
//}
//
//// Player draws card from top of deck and places at the hand space
//void Deck::draw(vector<Card> d, vector<Card> h) {
//	h[h.size() - 1] = d[0];
//}
//
//// Shuffle deck method
//vector<Card> Deck::shuffleDeck(vector<Card> d) {
//	random_device rd;
//	mt19937 g(rd());
//
...
//void Deck::printDeck(vector<Card> d) {
//	int j = 0;
//	string str;
//	for (auto& i : d) {
...
//}
//
//void Deck::printCard(vector<Card> d, int i) {
